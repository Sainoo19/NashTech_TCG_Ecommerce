    ...
    public partial class InitDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RarityId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariants_Rarities_RarityId",
                        column: x => x.RarityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ProductId_RarityId",
                table: "ProductVariants",
                columns: new[] { "ProductId", "RarityId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_RarityId",
                table: "ProductVariants",
                column: "RarityId");
